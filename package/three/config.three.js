...
import { getOrbitControl } from "./orbitControl.three";
export const ParticleSystemAnimation = function (config) {
    ...
    const controls = getOrbitControl(CAMERA, RENDERER.domElement, config.orbitConfig);
    ...
    const rotate = () => {
        var _a;
        if ((_a = config.orbitConfig) === null || _a === void 0 ? void 0 : _a.autoRotate) {
...
//# sourceMappingURL=config.three.js.map